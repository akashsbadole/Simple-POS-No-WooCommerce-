	...
	<div class="wrap simple-pos-wrap">
		...
		<div class="simple-pos-card simple-pos-table-card simple-pos-receipt-print" style="margin-top:12px">
			<table class="widefat striped simple-pos-table simple-pos-receipt-meta">
				...
				<?php if ( ! empty( $sale->outlet_id ) && class_exists( 'Simple_POS_Smo_Outlets' ) && ( $pos_sale_outlet = Simple_POS_Smo_Outlets::get_outlet( (int) $sale->outlet_id ) ) ) : ?>
				<tr><th><?php esc_html_e( 'Outlet', 'simple-pos' ); ?></th><td><?php echo esc_html( $pos_sale_outlet->name ); ?></td></tr>
				<?php endif; ?>
...
$pos_outlet_filter = ( class_exists( 'Simple_POS_Addons' ) && Simple_POS_Addons::is_enabled( 'simple-pos-multi-outlet' ) && class_exists( 'Simple_POS_Smo_Outlets' ) ) ? Simple_POS_Smo_Outlets::get_outlets() : array();
...
<div class="wrap simple-pos-wrap">
	...
	<div class="simple-pos-card simple-pos-filter-bar">
		<form method="get" class="simple-pos-filters">
			...
			<div class="simple-pos-filter-field">
				<label for="sales-outlet"><?php esc_html_e( 'Outlet', 'simple-pos' ); ?></label>
				<select id="sales-outlet" name="outlet_id">
					<option value="0"><?php esc_html_e( 'All outlets', 'simple-pos' ); ?></option>
