...
$low_stock_filter = isset( $_GET['filter'] ) && 'low_stock' === sanitize_key( wp_unslash( $_GET['filter'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
...
<div class="wrap simple-pos-wrap simple-pos-products-page">
	...
	<div class="simple-pos-action-grid">
		<div class="simple-pos-action-group">
			<h3><?php esc_html_e( 'Barcode', 'simple-pos' ); ?></h3>
			<div class="simple-pos-action-items">
				<a class="button" href="<?php echo esc_url(admin_url('admin.php?page=simple-pos-barcode'));?>"><?php esc_html_e( 'Barcode Labels', 'simple-pos' ); ?></a>
			</div>
		</div>
		<div class="simple-pos-action-group">
			<h3><?php esc_html_e( 'Categories', 'simple-pos' ); ?></h3>
			<div class="simple-pos-action-items">
				<a class="button" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=simple_pos_export_categories'), 'simple_pos_export_categories'));?>"><?php esc_html_e( 'Export Categories CSV', 'simple-pos' ); ?></a>
				<form method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('admin-post.php'));?>" class="simple-pos-inline-form">
					...
					<button class="button" type="submit"><?php esc_html_e( 'Import Categories CSV', 'simple-pos' ); ?></button>
				</form>
			</div>
		</div>
		<div class="simple-pos-action-group">
			<h3><?php esc_html_e( 'Products', 'simple-pos' ); ?></h3>
			<div class="simple-pos-action-items">
				<a class="button" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=simple_pos_export_products'), 'simple_pos_export_products'));?>"><?php esc_html_e( 'Export Products CSV', 'simple-pos' ); ?></a>
				<form method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('admin-post.php'));?>" class="simple-pos-inline-form">
		...
		<div class="simple-pos-action-group">
			<h3><?php esc_html_e( 'Variants', 'simple-pos' ); ?></h3>
			<div class="simple-pos-action-items">
				<a class="button" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=simple_pos_export_variants'), 'simple_pos_export_variants'));?>"><?php esc_html_e( 'Export Variants CSV', 'simple-pos' ); ?></a>
				<form method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('admin-post.php'));?>" class="simple-pos-inline-form">
