...
<div class="wrap simple-pos-wrap">
	...
	<p class="simple-pos-muted" style="margin:0 0 16px"><?php esc_html_e( 'Download a complete JSON backup of all POS data, or restore from a previous backup. Keep backup files in a safe place.', 'simple-pos' ); ?></p>
	...
	<div class="simple-pos-card simple-pos-form-card" style="margin-top:20px">
		<h2 class="simple-pos-section-title" style="margin-top:0"><?php esc_html_e( 'Restore from Backup', 'simple-pos' ); ?></h2>
		<p class="simple-pos-muted" style="margin:0 0 12px"><?php esc_html_e( 'Upload a JSON backup file to restore. This will replace existing data with the same IDs.', 'simple-pos' ); ?></p>
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
			...
			<div class="simple-pos-form-row">
				<label><?php esc_html_e( 'Backup file', 'simple-pos' ); ?></label>
				<input type="file" name="backup_file" accept=".json" required />
			</div>
			<div class="simple-pos-form-actions" style="margin-top:10px">
				<button type="submit" class="button button-primary"><?php esc_html_e( 'Restore Backup', 'simple-pos' ); ?></button>
			</div>
		</form>
	</div>
</div>
