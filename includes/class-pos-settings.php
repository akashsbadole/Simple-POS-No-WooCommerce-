...
class Simple_POS_Settings {
	...
	public static function update( $input ) {
		...
		$sanitized = array(
			...
			'store_address'            => isset( $input['store_address'] ) ? sanitize_textarea_field( $input['store_address'] ) : $current['store_address'],
			'store_phone'              => isset( $input['store_phone'] ) ? sanitize_text_field( $input['store_phone'] ) : $current['store_phone'],
			'store_email'              => isset( $input['store_email'] ) ? sanitize_email( $input['store_email'] ) : $current['store_email'],
			'store_gstin'              => isset( $input['store_gstin'] ) ? sanitize_text_field( $input['store_gstin'] ) : $current['store_gstin'],
