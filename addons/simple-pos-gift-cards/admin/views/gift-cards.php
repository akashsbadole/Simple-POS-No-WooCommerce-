...
<div class="wrap simple-pos-wrap">
	<div class="simple-pos-page-header">
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Gift Cards', 'wp-pos-plugin' ); ?></h1>
	</div>

	<?php if ( 'created' === $msg ) : ?>
		<div class="notice notice-success is-dismissible"><p><?php esc_html_e( 'Gift card created.', 'wp-pos-plugin' ); ?></p></div>
	<?php elseif ( 'topup' === $msg ) : ?>
		<div class="notice notice-success is-dismissible"><p><?php esc_html_e( 'Balance topped up.', 'wp-pos-plugin' ); ?></p></div>
	<?php elseif ( 'invalid' === $msg ) : ?>
		<div class="notice notice-error is-dismissible"><p><?php esc_html_e( 'Code and a positive amount are required.', 'wp-pos-plugin' ); ?></p></div>
	<?php endif; ?>

	<div class="simple-pos-columns">
		<div class="simple-pos-col-main">
			<div class="simple-pos-card simple-pos-table-card">
				<div class="simple-pos-card-head"><h2 class="simple-pos-section-title"><?php esc_html_e( 'Cards', 'wp-pos-plugin' ); ?></h2></div>
				<table class="wp-list-table widefat striped simple-pos-table">
					<thead><tr>
						<th><?php esc_html_e( 'Code', 'wp-pos-plugin' ); ?></th>
						<th class="num"><?php esc_html_e( 'Balance', 'wp-pos-plugin' ); ?></th>
						<th><?php esc_html_e( 'Status', 'wp-pos-plugin' ); ?></th>
						<th><?php esc_html_e( 'Created', 'wp-pos-plugin' ); ?></th>
						<th><?php esc_html_e( 'Top up', 'wp-pos-plugin' ); ?></th>
					</tr></thead>
					<tbody>
						<?php if ( empty( $cards ) ) : ?>
							<tr><td colspan="5" class="simple-pos-empty"><?php esc_html_e( 'No gift cards yet.', 'wp-pos-plugin' ); ?></td></tr>
						<?php endif; ?>
							...
							<tr>
								...
								<td>
									<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="simple-pos-inline-form">
										...
										<button class="button" type="submit"><?php esc_html_e( 'Add', 'wp-pos-plugin' ); ?></button>
									</form>
								</td>
							</tr>
						<?php endforeach; ?>
		...
		<div class="simple-pos-col-side">
			<div class="postbox simple-pos-form-card">
				<h2 class="hndle"><span><?php esc_html_e( 'Create Card', 'wp-pos-plugin' ); ?></span></h2>
				<div class="inside">
