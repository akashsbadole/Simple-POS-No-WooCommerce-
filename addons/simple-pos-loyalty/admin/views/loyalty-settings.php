...
$settings = Simple_POS_Sloy_Loyalty::get_settings();
...
<div class="wrap simple-pos-wrap">
	<div class="simple-pos-page-header">
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Loyalty Points', 'simple-pos' ); ?></h1>
	</div>
			...
			<div class="simple-pos-card">
				...
				<div class="inside" style="padding:16px">
					<ul style="list-style:disc inside;margin:0;line-height:2">
						<li><?php esc_html_e( 'Customers earn points on every sale based on the points-per-currency rate.', 'simple-pos' ); ?></li>
						<li><?php esc_html_e( 'Points are stored in a per-customer ledger. Voids reverse the earned points.', 'simple-pos' ); ?></li>
						<li><?php esc_html_e( 'At checkout, customers can redeem points for a fixed-amount discount.', 'simple-pos' ); ?></li>
						<li><?php esc_html_e( 'Enable the loyalty integration in POS → Add-ons to activate.', 'simple-pos' ); ?></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="simple-pos-stack">
						...
						<div class="simple-pos-form-row">
							<label>
								...
								<?php esc_html_e( 'Enable loyalty points', 'simple-pos' ); ?>
							</label>
						</div>
						<div class="simple-pos-form-row">
							<label for="sloy-ppc"><?php esc_html_e( 'Points per currency unit', 'simple-pos' ); ?></label>
						...
						<div class="simple-pos-form-row">
							<label for="sloy-cpp"><?php esc_html_e( 'Currency value per point', 'simple-pos' ); ?></label>
						...
						<div class="simple-pos-form-row">
							<label for="sloy-min"><?php esc_html_e( 'Minimum points to redeem', 'simple-pos' ); ?></label>
						...
						<div class="simple-pos-form-row">
							<label for="sloy-max"><?php esc_html_e( 'Max discount (% of subtotal)', 'simple-pos' ); ?></label>
